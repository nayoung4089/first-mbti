...
function Quiz(questions){
  ...
  var questions = [
    ...
    new Question('친구들과 놀던 중,<br> 저 멀리 한 이성이 눈에 들어온다.<br>꿈꾸던 이상형. 그 사람은...', ['높은 코에 적당히 큰 눈. 고운 피부를 가졌다.','JUST 엄청나다. 그냥 대박이다.'], ['S','N']),
...
var backcolor = ["#f9faf2", "rgb(163, 162, 182)", "#79e68b"];
...
updateQuiz();
// var box = document.querySelector('.flower-1');
// var boxx = document.querySelector('.flower-2');
...
// document.getElementById("resultbutton").addEventListener('click',result());